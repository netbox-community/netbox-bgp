...
class NetBoxBGPASPathListFilter(NetBoxModelFilter):
    name: StrFilterLookup[int] | None = strawberry_django.filter_field()
    description: StrFilterLookup[int] | None = strawberry_django.filter_field()

@strawberry_django.filter_type(ASPathListRule, lookups=True)
class NetBoxBGPASPathListRuleFilter(NetBoxModelFilter):
    value: StrFilterLookup[int] | None = strawberry_django.filter_field()
    aspath_list: (
        Annotated[
...
class NetBoxBGPSessionFilter(TenancyFilterMixin, NetBoxModelFilter):
    ...
    remote_as_macro: StrFilterLookup[int] | None = strawberry_django.filter_field()
